    ...
    if ("" != document.getElementById("price1").value)
        if ("" != document.getElementById("qty1").value)
            if ("" != document.getElementById("price2").value)
                ...
                } else document.getElementById("error4").innerHTML = "Quantity required";
            else document.getElementById("error3").innerHTML = "Price required";
        else document.getElementById("error2").innerHTML = "Quantity required";
    else document.getElementById("error1").innerHTML = "Price required"
}
