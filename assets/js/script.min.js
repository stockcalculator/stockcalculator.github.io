        ...
        if ("" != document.getElementById("price1").value)
            if ("" != document.getElementById("qty2").value)
                if ("" != document.getElementById("price2").value) {
                    ...
                    document.getElementById("investedamount1").innerHTML = "<span>Your amount invested in the 1st purchase: </span>  <span class='qty-amount'>" + (e * t).toLocaleString(intlLanguage) + "</span>", document.getElementById("investedamount2").innerHTML = "<span>Your amount invested in the 2nd purchase: </span> <span class='qty-amount'>" + (c * a).toLocaleString(intlLanguage) + "</span>", document.getElementById("result").innerHTML = "<span>Total units </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bold>" + l + "</bold><br/><br/><span>Average Price</span> &nbsp;&nbsp;&nbsp;<bold>" + d.toLocaleString(intlLanguage) + "</bold><br/><br/><span>Total Amount</span> &nbsp;&nbsp;&nbsp;<bold>" + n.toLocaleString(intlLanguage) + "</bold>"
